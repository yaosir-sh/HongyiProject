...
namespace AMTransferTool
{
    ...
    {  //数据库连接字符串(web.config来配置)，可以动态更改connectionString支持多数据库.    
        ...
        //public static string connectionString = System.Web.Configuration.WebConfigurationManager.ConnectionStrings["DbHelperConnectionString"].ToString();
        void SqlServerHelper() { }
